...
public class MyAdapter2 extends RecyclerView.Adapter<MyAdapter2.ViewHolder> {
    ...
    private ArrayList<String> TimeTaken = new ArrayList<>();
    private ArrayList<String> DateComp = new ArrayList<>();
    ...
    public MyAdapter2(ArrayList<String> taskNo, ArrayList<String> imageNames, ArrayList<String> desc, ArrayList<String> prio, ArrayList<String> time, ArrayList<String> date, ArrayList<String> timetaken,ArrayList<String> datecomp,Context context) {
    ...
    public void onBindViewHolder(@NonNull MyAdapter2.ViewHolder holder, int position) {
       ...
       final int index = position;
        ...
        holder.Date.setText(DateComp.get(position));
